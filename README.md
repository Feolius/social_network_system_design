...
3 ssd (sata) 8 tb либо 1 (nVME)

Выбираем 30 дисков, т.к. iops нагрузка.
...
Выбираем ssd, т.к. храним много данных.
...
Выбираем 10 дисков, т.к. характер нагрузки iops + дешевле.